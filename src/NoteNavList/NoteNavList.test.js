...
import NoteNavList from './NoteNavList'

describe(`NoteNavList component`, () => {
  const props = {
    notes: [
      {
  ...
  it('renders a .NoteNavList by default', () => {
    const wrapper = shallow(<NoteNavList />)
    expect(toJson(wrapper)).toMatchSnapshot()
  })

  it('renders a link in ul for each folder in array', () => {
    const ul = shallow(<NoteNavList {...props} />)
      .find('ul')
